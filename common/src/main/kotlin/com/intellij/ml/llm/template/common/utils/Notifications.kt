...
import com.intellij.ml.llm.template.common.settings.openSettingsDialog
...
fun showEFNotification(project: Project, message: String, notificationType: NotificationType) {
    createNotificationGroup().createNotification(
