...
public final class ExtractMethodHelper {
                ...
                for (SimpleMatch match : duplicates) {
                    ...
                    if (!replaceAll) {
                        ...
                        if (promptResult == FindManager.PromptResult.OK) {
                            ...
                            replaceAll = isReplaceAll(replacer, project, replacement);
                        }
                    }
                    else {
                        replaceDuplicate(project, replacer, replacement);
    ...
    private static boolean isReplaceAll(Consumer<? super Pair<SimpleMatch, PsiElement>> replacer, Project project, Pair<SimpleMatch, PsiElement> replacement) {
        boolean replaceAll;
        replaceDuplicate(project, replacer, replacement);
        replaceAll = true;
        return replaceAll;
