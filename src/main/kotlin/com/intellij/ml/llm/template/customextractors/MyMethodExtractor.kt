...
class MyMethodExtractor(private val functionNameProvider: FunctionNameProvider? = null) {
    ...
    fun findAndSelectExtractOption(
        ...
        try {
            ...
            val context = PsiTreeUtil.getContextOfType(elements.first(), PsiClass::class.java)
            ...
            if (context is PsiClass) {
                if (extractFunctionType == MethodExtractionType.PARENT_CLASS) {
                    filteredOptionsToExtract = filteredOptionsToExtract.filter { it.targetClass == context }
            ...
            return selectOptionWithTargetClass(editor, project, filteredOptionsToExtract)
